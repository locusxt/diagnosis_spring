							...
							<div>
								<form class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="col-sm-10">
											<div>
												同时有 <span id="symptom_list"></span> 症状。 
												<a href="" onclick=""><span>增加</span></a>
											</div>
											<div>
												...
												<div>
													<select id="dataobj_select" class="form-control select select-primary">
													...
													<select id="dataobj_type_select" class="form-control select select-primary">
														<option value="range">范围</option>
														<option value="ge">大于</option>
														<option value="le">小于</option>
													</select>
													<div id="dataobj_input">
