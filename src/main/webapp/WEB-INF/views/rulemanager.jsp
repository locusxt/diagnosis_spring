...
<html>
	...
	<body style="padding:0px; background-color:#f4f6f4">
								...
								<form class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="col-sm-10">
											...
											<a href="" data-toggle="modal" data-target="#new_term_modal"><span aria-hidden="true">点击新建term</span></a>
											<div>
												<div class="col-sm-7">
									...
									<div class="control-group">
										...
										<div class="col-sm-10">
											<!-- <a href="" data-toggle="modal" data-target="#new_term_modal"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a> -->
											<a href="" data-toggle="modal" data-target="#new_hterm_modal"><span aria-hidden="true">点击新建hterm</span></a>
											<div>
												<div class="col-sm-7">
		...
		<!-- add new hterm Modal -->
		<div class="modal fade" id="new_hterm_modal" tabindex="-1" role="dialog" aria-labelledby="new_hterm_label" aria-hidden="true">
		  <div class="modal-dialog">
			<div class="modal-content">
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="new_hterm_label">新建term</h4>
			  </div>
			  <div class="modal-body" id="new_hterm_body">
				<div>
					<script type="text/javascript">
						function gen_node_input2(nodeid){
							str = "<div class=col-sm-12><div class=input-group><div class=input-group-btn><select id=n2type" + nodeid + " class='form-control select select-primary'><option value=VAR >变量</option><option value=TYPE >关系</option><option value=NUM >数字</option><option value=OTHER >其他</option></select></div><input type=text class=form-control id=n2content" + nodeid + " /></div></div><br /><br />";
							document.write(str);
						}

						function gen_new_hterm(){
							var nodes = new Array(3);
							for (var i = 0; i < 3; ++i){
								var type = $('#n2type' + i).val();
								var content = $('#n2content' + i).val();
								nodes[i] = [type, content];
							}
			  ...
			  <div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
				<button type="button" class="btn btn-primary" onclick="gen_new_hterm();refresh_hterms_table();" data-dismiss="modal">保存</button>
			  </div>
			</div>
		  </div>
		</div>
